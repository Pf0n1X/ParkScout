...
@Database(entities = [ChatMessage::class , TrainingSpot:: class,Comment:: class,Rating::class,SportTypes::class, Chat::class,Images::class, User::class, UserChatCrossRef::class], version = 8)
